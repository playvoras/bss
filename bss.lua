...
Copylinkdiscord.MouseButton1Down:Connect(
    function()
        setclipboard("discord.gg/GT6uXF2")
    end
)

HomeButton.MouseButton1Down:Connect(
    function()
        HomeButton.BackgroundColor3 = Color3.new(0.345098, 0.14902, 1)
        FarmingButton.BackgroundColor3 = Color3.new(0.34902, 0.32549, 1)
        WaypointsButton.BackgroundColor3 = Color3.new(0.34902, 0.32549, 1)
...
FarmingButton.MouseButton1Down:Connect(
    function()
...
WaypointsButton.MouseButton1Down:Connect(
    function()
        HomeButton.BackgroundColor3 = Color3.new(0.34902, 0.32549, 1)
        FarmingButton.BackgroundColor3 = Color3.new(0.34902, 0.32549, 1)
...
ExtrasButton.MouseButton1Down:Connect(
    function()
        HomeButton.BackgroundColor3 = Color3.new(0.34902, 0.32549, 1)
        FarmingButton.BackgroundColor3 = Color3.new(0.34902, 0.32549, 1)
        WaypointsButton.BackgroundColor3 = Color3.new(0.34902, 0.32549, 1)
...
SettingButton.MouseButton1Down:Connect(
    function()
        HomeButton.BackgroundColor3 = Color3.new(0.34902, 0.32549, 1)
        FarmingButton.BackgroundColor3 = Color3.new(0.34902, 0.32549, 1)
        WaypointsButton.BackgroundColor3 = Color3.new(0.34902, 0.32549, 1)
...
Destroy.MouseEnter:Connect(
    function()
        Destroy.TextColor3 = Color3.new(255, 0, 0)
    end
)

Destroy.MouseLeave:Connect(
    function()
...
Autokillmonster.MouseButton1Down:connect(
    function()
...
WindyBeetp.MouseButton1Down:connect(
    function()
...
Diamondmasktp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Demonmasktp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Stinger.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
TunelBeartp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
GummyMask.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Coconutshoptp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Petaltp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Stumptp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Suntp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Dantp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Clovertp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Bambootp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Blueftp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Mushtp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Spidertp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Strawtp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Pineappletp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Rosetp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Castustp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Pumtp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Pintreetp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Toptp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Coconuttp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Peppertp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Autored.MouseButton1Down:connect(
    function()
        MainPage.Visible = false
        Close.Text = "+"
...
Autoblue.MouseButton1Down:connect(
    function()
        MainPage.Visible = false
        Close.Text = "+"
...
AutoDispenser_2.MouseButton1Down:connect(
    function()
        MainPage.Visible = false
        Close.Text = "+"
...
Afkstumptp.MouseButton1Down:connect(
    function(l)
...
Shopbasictp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Shopproctp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Shoptoptp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Shopsprinklertp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Shopmoontp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
InstantConversiontp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
MegaMemorytp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
NightMemorytp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
ExtremeMemorytp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
StartHalltp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
SummonSprouttp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
Anttp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
        uTorso.CFrame = Waypoints["Ant"]
        MainPage.Visible = false
...
Kingamulettp.MouseButton1Down:connect(
    function()
        local uTorso = workspace:WaitForChild(game.Players.LocalPlayer.Name).HumanoidRootPart
...
AutoDispenser.MouseButton1Down:connect(
    function()
...
Dropweapon.MouseButton1Down:connect(
    function()
        MainPage.Visible = false
        Close.Text = "+"
...
KillTunnel.MouseButton1Down:connect(
    function(j)
                ...
                for _, v in pairs(game.Workspace.Monsters:GetChildren()) do
                    if string.find(v.Name, "Tunnel") then
                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                            v.HumanoidRootPart.CFrame * CFrame.new(0, 20.5, 0)
                    end
                end
            end
        else
...
Killcoconutcrab.MouseButton1Down:connect(
    function()
...
local stinger = false
Autostinger.MouseButton1Down:connect(
    function(b)
...
local item = false
Autobuffitem.MouseButton1Down:connect(
    function(c)
        if item == false then
            MainPage.Visible = false
            Close.Text = "+"
...
local gliter = false
Autogliter.MouseButton1Down:connect(
    function(d)
...
local coconut = false
Autococonut.MouseButton1Down:connect(
    function(e)
...
local AutoDig = false
Autodig.MouseButton1Down:connect(
    function()
...
Useglitter.MouseButton1Down:connect(
    function()
                ...
                for k, v in pairs(workspace.Collectibles:GetChildren()) do
                    if tostring(v) == tostring(game.Players.LocalPlayer.Name) or tostring(v) == test then
                        if (v.Position - plr.Character.HumanoidRootPart.Position).magnitude <= 60 then
                            item.CFrame =
                                CFrame.new(v.Position.x, plr.Character.HumanoidRootPart.Position.y, v.Position.z)
...
local gumdrop = false
Autogumdrop.MouseButton1Down:connect(
    function(h)
...
Equipgummymask.MouseButton1Down:connect(
    function()
        MainPage.Visible = false
        Close.Text = "+"
        local A_1 = "Equip"
...
local tpwindy = false
Autokillwindy.MouseButton1Down:connect(
    function(o)
            ...
            while tpwindy do
                ...
                for _, v in pairs(game.workspace.Monsters:GetChildren()) do
                    if string.find(v.Name, "Windy") then
                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                            v.Torso.CFrame * CFrame.new(0, 25, 0)
                    end
                end
...
local tornado = false
Bringtornado.MouseButton1Down:connect(
    function()
...
Equipdemonmask.MouseButton1Down:connect(
    function()
        MainPage.Visible = false
        Close.Text = "+"
        local A_1 = "Equip"
...
Eqipdemonmask.MouseButton1Down:connect(
    function()
        MainPage.Visible = false
        Close.Text = "+"
        local A_1 = "Equip"
...
local Drop = false
Automagicbean.MouseButton1Down:connect(
    function(a)
        if Drop == false then
            MainPage.Visible = false
            Close.Text = "+"
...
local Windy = false
FindWindBee.MouseButton1Down:connect(
    function(w)
        if Windy == false then
            MainPage.Visible = false
            Close.Text = "+"
...
Usenightbell.MouseButton1Down:connect(
    function()
        MainPage.Visible = false
        Close.Text = "+"
        local A = {
...
Usefielddice.MouseButton1Down:connect(
    function()
        MainPage.Visible = false
        Close.Text = "+"
        local A = {
...
Autokillvicious.MouseButton1Down:connect(
    function(q)
...
SunflowerButton.MouseButton1Down:connect(
    function()
        tuoidz = "Sunflower Field"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
MushroomButton.MouseButton1Down:connect(
    function()
        tuoidz = "Mushroom Field"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
DanrButton.MouseButton1Down:connect(
    function()
        tuoidz = "Dandelion Field"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
DanrButton_2.MouseButton1Down:connect(
    function()
        tuoidz = "Clover Field"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
BlueflowerButton.MouseButton1Down:connect(
    function()
        tuoidz = "Blue Flower Field"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
BambooButton.MouseButton1Down:connect(
    function()
        tuoidz = "Bamboo Field"
        FieldText.Text = "Field Select: " .. tuoidz
    end
...
SpiderButton.MouseButton1Down:connect(
    function()
        tuoidz = "Spider Field"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
StawberryButton.MouseButton1Down:connect(
    function()
...
PineappleButton.MouseButton1Down:connect(
    function()
        tuoidz = "Pineapple Patch"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
StumpButton.MouseButton1Down:connect(
    function()
        tuoidz = "Stump Field"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
RoseButton.MouseButton1Down:connect(
    function()
        tuoidz = "Rose Field"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
CactusButton.MouseButton1Down:connect(
    function()
        tuoidz = "Cactus Field"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
PumpkinButton.MouseButton1Down:connect(
    function()
        tuoidz = "Pumpkin Patch"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
PineTreeButton.MouseButton1Down:connect(
    function()
        tuoidz = "Pine Tree Forest"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
MountainTopButton.MouseButton1Down:connect(
    function()
        tuoidz = "Mountain Top Field"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
CoconutButton.MouseButton1Down:connect(
    function()
        tuoidz = "Coconut Field"
        FieldText.Text = "Field Select: " .. tuoidz
    end
)
PepperButton.MouseButton1Down:connect(
    function()
        tuoidz = "Pepper Patch"
        FieldText.Text = "Field Select: " .. tuoidz
    end
...
StartButton.MouseButton1Down:connect(
    function()
        if act6 == true then
            act6 = false
                    ...
                    repeat
                        ...
                        for k, v in pairs(workspace[player.Name]:GetChildren()) do
                            if v:FindFirstChild("Display") then
                                if
                                    v.Display.Gui.ProgressBar.Size == v.Display.Gui.RedBar.Size or
                                        v.Display.Gui.ProgressLabel ==
                                            player.CoreStats.Pollen.Value .. "/" .. player.CoreStats.Pollen.Value
                                 then
                                    act6temp = true
                                    wait(3)
                                    local sanghuman = player.Character.HumanoidRootPart
                                    ...
                                    repeat
                                        wait(.1)
                                    until player.CoreStats.Pollen.Value <= 1
                                    wait(7)
                                    sanghuman.CFrame = sangzboi * CFrame.new(0, 0, 0)
                                    wait(1)
                                    local A = {
...
RemoteQuest.MouseButton1Down:connect(
    function()
        if act5 == true then
            act5 = false
    ...
    function()
        while wait() do
            ...
            if game.Players.LocalPlayer.UserId == truonghopdacbiet or game.Players.LocalPlayer.Name == truonghopdacbiet2 then
                if
                    act6 == true or act5 == true or afksnail == true or killvici == true or Sparkles == true or
                        tornado == true or
                        dispenser == true or
                        killtunell == true or
                        killcoconut == true or
...
Killstumnail.MouseButton1Down:connect(
    function()
        if afksnail == false then
            afksnail = true
            ...
            while afksnail do
                ...
                for _, v in pairs(game.workspace:GetDescendants()) do
                    if string.find(v.Name, "LeafBurst") then
                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                            v.Parent.CFrame * CFrame.new(0, 0, 0)
                    end
                end
                for k, v in pairs(workspace.Collectibles:GetChildren()) do
                    if tostring(v) == tostring(game.Players.LocalPlayer.Name) or tostring(v) == test then
